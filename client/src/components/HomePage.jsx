...
// --- Sample Data ---
const sampleMenuItems = [ /* ... Same sample data as before ... */ 
   { id: 'clv9sample1', name: 'Ragi Vegetable Chilla', price: 12000, category: 'Breakfast', cuisineRegion: 'North Indian', mealType: 'Chilla', dietType: 'With Onion/Garlic', isVeg: true, calories: 320, protein: 7, carbs: 40, fat: 12, fiber: 6, glycemicIndex: 'Low', isHighProtein: false, isHighFiber: true, isHeartHealthy: true, imageUrl: 'https://via.placeholder.com/180x180/10B981/FFFFFF?text=Ragi+Chilla', isFeatured: true, standardIngredients: 'Ragi flour, Grated carrot, Chopped spinach/methi, Finely chopped onion, Green chili, ginger, Cumin seeds, Salt, Cold-pressed oil', createdAt: new Date().toISOString(), updatedAt: new Date().toISOString(), }, { id: 'clv9sample2', name: 'Oats Idli', price: 10000, category: 'Breakfast', cuisineRegion: 'South Indian', mealType: 'Idli', dietType: 'Without Onion/Garlic', isVeg: true, calories: 150, protein: 7, carbs: 22, fat: 3, fiber: 5, glycemicIndex: 'Low', isHighProtein: false, isHighFiber: true, isHeartHealthy: true, imageUrl: 'https://via.placeholder.com/180x180/10B981/FFFFFF?text=Oats+Idli', isFeatured: true, standardIngredients: 'Ground oats, Urad dal, Grated carrot, Chopped coriander, Curry leaves, Green chilies, Ginger, Eno fruit salt, Salt', createdAt: new Date().toISOString(), updatedAt: new Date().toISOString(), }, { id: 'clv9sample3', name: 'Moong Dal Paneer Cheela', price: 16000, category: 'Breakfast', cuisineRegion: 'North Indian', mealType: 'Cheela', dietType: 'With Onion/Garlic', isVeg: true, calories: 280, protein: 20, carbs: 25, fat: 10, fiber: 8, glycemicIndex: 'Low', isHighProtein: true, isHighFiber: true, isHeartHealthy: true, imageUrl: 'https://via.placeholder.com/180x180/10B981/FFFFFF?text=Moong+Dal+Cheela', isFeatured: true, standardIngredients: 'Split yellow moong dal, Grated paneer, Finely chopped onion, Chopped spinach, Green chilies, Ginger, Cumin powder, Coriander powder, Salt, Cold-pressed mustard oil', createdAt: new Date().toISOString(), updatedAt: new Date().toISOString(), }, { id: 'clv9sample4', name: 'Dal Khichdi (Bottle Gourd)', price: 15000, category: 'Lunch & Dinner', cuisineRegion: 'North Indian', mealType: 'Khichdi', dietType: 'With Onion/Garlic', isVeg: true, calories: 220, protein: 10, carbs: 32, fat: 5, fiber: 8, glycemicIndex: 'Medium', isHighProtein: true, isHighFiber: true, isHeartHealthy: true, imageUrl: 'https://via.placeholder.com/180x180/10B981/FFFFFF?text=Dal+Khichdi', isFeatured: false, standardIngredients: 'Moong dal, Toor dal, Brown rice, Bottle gourd, Tomato, Green peas, Onion, Ginger-garlic paste, Turmeric powder, Cumin seeds, Ghee, Salt', createdAt: new Date().toISOString(), updatedAt: new Date().toISOString(), },
];
// --- End Sample Data ---
...
const HomePage = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-zinc-50">
      {/* Header, Hero, Search, Filters, Categories sections remain the same */}
      ...
      {/* Featured Section - Simplified Card Layout */}
                  ...
                  <div className="flex cursor-pointer" onClick={() => navigate(`/item/${item.id}`)}> 
                    ...
                    <div className="w-2/3 p-3"> 
                      {/* Top Row */}
                       ...
                       {/* --- Middle Row: Nutritional Badges - TEMPORARILY COMMENTED OUT ---
                       ...
                       */}
                       ...
                       <div className="flex justify-between items-center mt-2.5"> {/* Ensure this margin is sufficient */}
                         <div className="font-bold text-lg">₹{item.price / 100}</div> 
                          {/* Add flex-shrink-0 to prevent button from shrinking */}
                         <button 
                            className="inline-flex items-center justify-center flex-shrink-0 bg-emerald-600 hover:bg-emerald-700 text-white text-xs rounded-md px-3 py-1.5 transition-colors" 
